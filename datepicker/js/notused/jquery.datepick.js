...
function Datepicker() {
	...
	this.regional = {
		'': { // US/English
			...
			prevText: '<img src="Public/Css/DatePicker/arrow-left.png" alt="&lt;Prev" />', // Text for the previous month command
			prevStatus: 'Show the previous month', // Status text for the previous month command
			prevJumpText: '&lt;&lt;', // Text for the previous year command
			prevJumpStatus: 'Show the previous year', // Status text for the previous year command
			nextText: '<img src="Public/Css/DatePicker/arrow-right.png" alt="Next&gt;" />', // Text for the next month command
...
$.extend(Datepicker.prototype, {
	...
	_attachments: function(target, inst) {
		...
		$('.trigger').next().remove(); // remove span class="r" and added again after it from the front end
